	...
	<div class="container">
		<form name="newMember" class="form-horizontal" action="processUpdateMember.jsp" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="email" name="email" maxlength="50" class="form-control text-center" value="<c:out value='${row.email }'/>">
				</div>				
			</div>
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input id="phone" name="phone" type="text" 
					       ...
					       maxlength="13" size="13" value="<c:out value='${row.phone }'/>" >
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2">우편번호</label>					
				<div class="col-sm-3"> 
					<input type="text" id="postcd" name="postcd" maxlength="5" class="form-control" readonly="readonly" value="<c:out value='${row.postcd }'/>"> 
				</div>
				<div class="col-sm-2">
			...
			<div class="form-group row">
				...
				<div class="col-sm-7">
					<input id="addr1" name="addr1" type="text" readonly="readonly"
					       class="form-control"  value="<c:out value='${row.addr1 }'/>" />
				</div>				
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-7">
					<input id="addr2" name="addr2"  type="text"  class="form-control" value="<c:out value='${row.addr2 }'/>" />
				</div>				
			</div>
			<div class="form-group row">
				<div class="col-sm-6 text-center">
					<input type="submit" class="col-sm-3 btn btn-primary" value="등록" onclick="checkValue()"> 
