...
<html lang="ko">
    ...
    <c:choose>
	    <c:when test="${empty sessionId}">
				...
				<li style="padding-top:8px; color:black;font-size:22px"><c:forEach var="row" items="${result.rows}"><c:out value="${row.name}"/></c:forEach>님</li>
			      <li class="dropdown"><a class="btn-lg dropdown-toggle" data-toggle="dropdown" href="#">관리자용</a>
			        <ul class="dropdown-menu">
		              <li class="list-group-item" style="font-size:20px;"><a href="<c:url value="phoneRegistForm.jsp"/>">상품 등록</a></li>
			...
			<c:when test="${sessionId!='admin'}">
				<li style="padding-top:8px; color:black;font-size:22px"><c:forEach var="row" items="${result.rows}"><c:out value="${row.name}"/></c:forEach>님</li>
				<li style="font-weight:bold" class="nav-item"><a class="btn-lg nav-link" href="<c:url value="phonePurchaseList.jsp"/>">내 구매목록 </a></li>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a style="font-size:20px;" class="nav-link active" aria-current="page" href="../member/mainMenu.jsp">Home</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li style="font-size:20px;"><a class="dropdown-item" href="${pageContext.request.contextPath}/board/qna_board_list.jsp">자유 게시판</a></li>
