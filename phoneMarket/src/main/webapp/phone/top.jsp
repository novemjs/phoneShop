            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item" style="font-size:20px;"><a class="nav-link active" aria-current="page" href="../member/mainMenu.jsp">Home</a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
					    ...
					    <c:when test="${empty sessionId}">
					    	<li><a  class="btn-lg " href="<c:url value="../member/loginMember.jsp"/>"><span class="glyphicon glyphicon-user"></span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-door-open" viewBox="0 0 16 16">
							  <path d="M8.5 10c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1z"/>
							  <path d="M10.828.122A.5.5 0 0 1 11 .5V1h.5A1.5 1.5 0 0 1 13 2.5V15h1.5a.5.5 0 0 1 0 1h-13a.5.5 0 0 1 0-1H3V1.5a.5.5 0 0 1 .43-.495l7-1a.5.5 0 0 1 .398.117zM11.5 2H11v13h1V2.5a.5.5 0 0 0-.5-.5zM4 1.934V15h6V1.077l-6 .857z"/>
							  </svg>로그인</a></li>
					    	<li><a  class="btn-lg " href="<c:url value="../member/addMember.jsp"/>"><span class="glyphicon glyphicon-log-in"></span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-apple" viewBox="0 0 16 16">
							...
							<c:when test="${sessionId!='admin'}">
								...
								<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="navbarDropdown" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">마이 페이지</a>
							        <ul class="dropdown-menu"  aria-labelledby="navbarDropdown">
						              <li><a class="dropdown-item" href="<c:url value="../member/logoutMember.jsp"/>">로그아웃</a></li>		
						              <li><a class="dropdown-item" href="<c:url value="../member/updateMember.jsp?id=${sessionId }"/>">회원 수정</a></li>
						              <li><a class="dropdown-item" href="<c:url value="../member/deleteMember.jsp?id=${sessionId }"/>">회원 삭제 </a></li>              
